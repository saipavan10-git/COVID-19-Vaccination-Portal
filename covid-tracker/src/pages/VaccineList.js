...
export default class VaccineList extends Component {
    ...
    render() {
        ...
        function sayHello(m) {
            ...
            alert(`Congrats! You booked ${m.vaccine_name} vaccine, ${m.vaccine_num}-dose. Please bring your valid ID/Driver's license and your insurance card with you.`)
        }
        if (!isLoaded) {
            return <p>Loading...</p>
        } else {
                            ...
                            <tbody>
                                ...
                                {vaccines.map((m) => (
                                    <tr key={m.id}>
                                        ...
                                        <td>{m.state}</td>
                                        <td>{m.zip_code}</td>
                                        <td><button onClick={() => { sayHello(m) }}>Book</button></td>
                                    </tr>
                                )
                                )}
                            </tbody>
