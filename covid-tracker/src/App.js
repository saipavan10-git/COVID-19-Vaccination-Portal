  ...
  return (
    <Router >
      <Routes>
        ...
        <Route path="/adminlogin" element={<AdminLogin setName={setName} name={name} />} />
        ...
        <Route path="/AdminPage" element={<AdminPage name={name} name2={name2} email={email} setName={setName} set2Name={set2Name} setEmail={setEmail} vaccine={vaccine} vaccineId={vaccineId} vaccineNum={vaccineNum} state={state} zipCode={zipCode} change={change} birthdate={birthdate} />} />
      </Routes>
    </Router>
  );
}
